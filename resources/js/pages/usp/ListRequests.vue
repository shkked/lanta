...
const hotSettings = {
	...
	columns: [
		...
		{ type: "date", data: "begin_reporting_period", dateFormat: "DD/MM/YYYY", title: "Начало периода" },
		{ type: "date", data: "end_reporting_period", dateFormat: "DD/MM/YYYY", title: "Конец периода" },
		{
			type: "text",
			data: "openRequests",
	...
	cells: (row, col) => {
		...
		cellProperties.renderer = (instance, td, row, col, prop, value, cellProperties) => {
			...
			if (rowData && rowData.is_completed) {
